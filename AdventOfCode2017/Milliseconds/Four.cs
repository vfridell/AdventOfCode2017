    ...
    public class Four
    {
        public static void Part1()
        {
            ...
            foreach(var list in input)
            {
                ...
                if (set.Count == list.Count) totalValid++;
            }

            Console.WriteLine($"{totalValid} valid passphrases");
        }

        public static void Part2()
        {
            var fd1 = FrequencyDistribution.CreateFrequencyDistribution("abcde");
            var fd2 = FrequencyDistribution.CreateFrequencyDistribution("ecbad");
            Console.WriteLine($"FrequencyDistributions are equal: {fd1.Equals(fd2)}");
            ...
            foreach (var list in input)
            {
                ...
                {
                    filteredInput.Add(list);
                }
            }

            foreach(var list in filteredInput)
            {
                HashSet<FrequencyDistribution> set = new HashSet<FrequencyDistribution>();
                foreach (string s in list) set.Add(FrequencyDistribution.CreateFrequencyDistribution(s));
                if (set.Count == list.Count) totalValid++;
            }
        ...
        class FrequencyDistribution : Dictionary<char, int>
        {
            private FrequencyDistribution()
            {
                for(int i='a'; i<='z'; i++) Add((char)i, 0);
            }

            public static FrequencyDistribution CreateFrequencyDistribution(string inputString)
            {
            ...
            {
                FrequencyDistribution other = obj as FrequencyDistribution;
                if (other == null) return false;
                return Equals(other);
            }

            public bool Equals(FrequencyDistribution other)
            {
                for (int i = 'a'; i < 'z'; i++)
                {
                    if (this[(char)i] != other[(char)i]) return false;
                }
                return true;
            }
            ...
            {
                return Values.Select(v => v.GetHashCode()).Sum();
            }
        }

        public static List<List<string>> input = new List<List<string>>()
        {
